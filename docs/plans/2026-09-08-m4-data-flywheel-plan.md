...
10. M4 services retain the project-wide `<4 GiB` total RSS stop line. A watchdog samples the exact Lab containers throughout the Gate; no memory limit is increased to make the Gate pass.
